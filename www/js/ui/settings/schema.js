...
(function () {
   ...
   const SETTINGS_SCHEMA = {
      ...
      documents: {
         ...
         fields: {
            /* Sub-grouped for readability.  documents.* config is flat, so each
             * field carries an explicit configPath (the group key is a label
             * container only) — same pattern as the memory section. */
            upload: {
               type: 'group',
               label: 'Upload & Extraction',
               fields: {
                  max_file_size_kb: {
                     type: 'number',
                     ...
                     max: 10240,
                     step: 64,
                     configPath: 'documents.max_file_size_kb',
                  ...
                  max_documents: {
                     ...
                     min: 1,
                     max: 20,
                     configPath: 'documents.max_documents',
                  ...
                  max_pages: {
                     ...
                     min: 1,
                     max: 500,
                     configPath: 'documents.max_pages',
                  ...
                  max_extracted_size_kb: {
                     ...
                     max: 4096,
                     advanced: true,
                     configPath: 'documents.max_extracted_size_kb',
            ...
            search: {
               ...
               advanced: true,
               description: 'RAG indexing limits and hybrid (keyword + semantic) search tuning.',
               fields: {
                  max_index_size_kb: {
                     type: 'number',
                     ...
                     max: 10240,
                     step: 128,
                     configPath: 'documents.max_index_size_kb',
                  ...
                  max_indexed_documents: {
                     ...
                     min: 1,
                     max: 500,
                     configPath: 'documents.max_indexed_documents',
                  ...
                  fts_label_weight: {
                     ...
                     max: 100,
                     step: 0.5,
                     configPath: 'documents.fts_label_weight',
                  ...
                  fts_body_weight: {
                     ...
                     max: 100,
                     step: 0.5,
                     configPath: 'documents.fts_body_weight',
                  ...
                  hybrid_keyword_weight: {
                     ...
                     max: 1,
                     step: 0.05,
                     configPath: 'documents.hybrid_keyword_weight',
                  ...
                  hybrid_vector_weight: {
                     ...
                     max: 1,
                     step: 0.05,
                     configPath: 'documents.hybrid_vector_weight',
                  ...
                  phrase_bonus_weight: {
                     ...
                     max: 1,
                     step: 0.05,
                     configPath: 'documents.phrase_bonus_weight',
                  ...
                  search_min_score: {
                     ...
                     max: 1,
                     step: 0.05,
                     configPath: 'documents.search_min_score',
            ...
            versioning: {
               ...
               advanced: true,
               description:
                  'Edits, overwrites, and deletes archive a snapshot first, for undo/restore.',
               fields: {
                  version_retention_days: {
                     ...
                     min: 0,
                     max: 3650,
                     configPath: 'documents.version_retention_days',
                  ...
                  version_keep_per_doc: {
                     ...
                     min: 1,
                     max: 1000,
                     configPath: 'documents.version_keep_per_doc',
            ...
            originals: {
               type: 'group',
               label: 'Original File Storage',
               description:
                  'Keep the raw uploaded file (not just extracted text) so it can be downloaded later and re-processed if extraction improves.',
               fields: {
                  originals_enabled: {
                     type: 'checkbox',
                     label: 'Store Original Files',
                     configPath: 'documents.originals_enabled',
                     hint: 'Keep the original uploaded PDF/DOCX (default: on). The settings below apply only when this is enabled.',
                  },
                  original_retention_days: {
                     ...
                     max: 3650,
                     advanced: true,
                     configPath: 'documents.original_retention_days',
                     showWhen: { key: 'documents.originals_enabled', value: true },
                     hint: 'Auto-delete stored originals after N days (default: 0 = keep forever; unreferenced uploads are still reclaimed by the orphan sweep).',
                  },
                  max_original_size_mb: {
                     type: 'number',
                     label: 'Max Original Size (MB)',
                     min: 1,
                     max: 512,
                     advanced: true,
                     configPath: 'documents.max_original_size_mb',
                     showWhen: { key: 'documents.originals_enabled', value: true },
                     hint: 'Largest original file to store (default: 10). Cannot exceed the upload size limit.',
                  },
                  max_originals_per_user: {
                     type: 'number',
                     label: 'Max Originals Per User',
                     min: 1,
                     max: 100000,
                     advanced: true,
                     configPath: 'documents.max_originals_per_user',
                     showWhen: { key: 'documents.originals_enabled', value: true },
                     hint: 'Per-user cap on stored original files (default: 200).',
                  },
                  max_originals_total_mb_per_user: {
                     type: 'number',
                     label: 'Max Originals Total Per User (MB)',
                     min: 0,
                     max: 1048576,
                     advanced: true,
                     configPath: 'documents.max_originals_total_mb_per_user',
                     showWhen: { key: 'documents.originals_enabled', value: true },
                     hint: 'Per-user aggregate storage cap for originals in MB (default: 2048; 0 = unlimited).',
                  },
                  original_grace_minutes: {
                     ...
                     max: 1440,
                     advanced: true,
                     configPath: 'documents.original_grace_minutes',
                     showWhen: { key: 'documents.originals_enabled', value: true },
                     hint: 'How long an uploaded-but-not-yet-saved original is kept before the orphan sweep reclaims it (default: 45). Must exceed a typical edit session.',
                  },
               },
            },
         },
      ...
      jobs: {
         ...
         fields: {
            enabled: {
               ...
               hint: 'Let the assistant run fire-and-forget tasks in the background',
               default: true,
            },
            max_active_jobs: {
               type: 'number',
               label: 'Max Active Jobs (global)',
               min: 1,
               max: 256,
               hint: 'Global ceiling on concurrently running background jobs',
               default: 16,
               advanced: true,
            },
            max_jobs_per_user: {
               ...
               min: 1,
               max: 64,
               hint: 'Per-user concurrent running background jobs',
               default: 4,
               advanced: true,
            },
            max_concurrent_local: {
               type: 'number',
               label: 'Max Concurrent (local LLM)',
               min: 0,
               max: 64,
               hint: 'Jobs allowed to run at once on a local (GPU) model — keep low',
               default: 1,
               advanced: true,
            },
            max_concurrent_cloud: {
               type: 'number',
               label: 'Max Concurrent (cloud LLM)',
               min: 0,
               max: 64,
               hint: 'Jobs allowed to run at once on a cloud model',
               default: 4,
               advanced: true,
            },
            max_runtime_sec: {
               ...
               min: 0,
               max: 86400,
               hint: 'Per-job time budget before it is reaped (0 = no limit)',
               default: 1800,
               advanced: true,
            },
            max_concurrent_reinvokes: {
               type: 'number',
               label: 'Max Concurrent Reinvokes',
               min: 1,
               max: 32,
               hint: 'How many finished jobs may re-engage their conversation at once',
               default: 2,
               advanced: true,
            },
            event_retention_days: {
            ...
            max_reinvokes_per_tree: {
               ...
               min: 1,
               max: 64,
               hint: 'Runaway guard: give up re-engaging after this many attempts on one job',
               default: 8,
               advanced: true,
            },
         },
